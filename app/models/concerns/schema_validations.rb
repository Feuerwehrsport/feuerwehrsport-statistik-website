...
# generated from version 20260304102552
...
module SchemaValidations
  ...
  class_methods do
    ...
    def dbv_active_record_views_validations(enums: [])
      ...
      validates_with_filter :options, {exclusion: {in: [nil], message: :blank}}
    ...
    def dbv_bla_badges_validations(enums: [])
      belongs_to_presence_validations_for([:hb_time, :person_id, :year])
    ...
    def dbv_change_logs_validations(enums: [])
      ...
      validates_with_filter :content, {exclusion: {in: [nil], message: :blank}}
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_competitions_validations(enums: [])
      belongs_to_presence_validations_for([:event_id, :fs_female, :fs_male, :gs, :hb_female, :hb_male, :hl_female, :hl_male, :la_female, :la_male, :people_count, :place_id, :teams_count, :year])
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_group_score_categories_validations(enums: [])
      belongs_to_presence_validations_for([:competition_id, :group_score_type_id])
      validates_with_filter :competition_id, {numericality: {allow_nil: true, only_integer: true, greater_than_or_equal_to: -2147483648, less_than: 2147483648}} unless enums.include?(:competition_id)
      validates_with_filter :competition_id, {presence: {}}
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_group_scores_validations(enums: [])
      belongs_to_presence_validations_for([:gender, :group_score_category_id, :team_id, :team_number, :time])
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_people_validations(enums: [])
      belongs_to_presence_validations_for([:fs_count, :gender, :gs_count, :hb_count, :hl_count, :la_count, :nation_id])
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_person_participations_validations(enums: [])
      belongs_to_presence_validations_for([:group_score_id, :person_id, :position])
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_scores_validations(enums: [])
      belongs_to_presence_validations_for([:competition_id, :person_id, :single_discipline_id, :team_number, :time])
      validates_with_filter :competition_id, {numericality: {allow_nil: true, only_integer: true, greater_than_or_equal_to: -2147483648, less_than: 2147483648}} unless enums.include?(:competition_id)
      validates_with_filter :competition_id, {presence: {}}
      validates_with_filter :created_at, {date_time_in_db_range: {}}
      validates_with_filter :created_at, {presence: {}}
    ...
    def dbv_teams_validations(enums: [])
      belongs_to_presence_validations_for([:competitions_count, :members_count, :status])
