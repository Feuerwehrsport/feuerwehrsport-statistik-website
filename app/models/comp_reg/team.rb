class CompReg::Team < ActiveRecord::Base
  include Genderable
  include Taggable
  belongs_to :competition, class_name: 'CompReg::Competition'
  belongs_to :admin_user
  belongs_to :federal_state
  has_many :team_assessment_participations, inverse_of: :team, dependent: :destroy, class_name: 'CompReg::TeamAssessmentParticipation'
  has_many :competition_assessments, through: :team_assessment_participations, class_name: 'CompReg::CompetitionAssessment'
  has_many :people, inverse_of: :team, dependent: :destroy, class_name: 'CompReg::Person'
