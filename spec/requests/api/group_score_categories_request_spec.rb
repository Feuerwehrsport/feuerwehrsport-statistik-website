...
RSpec.describe 'Api::GroupScoreCategories' do
  ...
  describe 'GET index' do
    ...
    it 'returns group_score_categories' do
      get '/api/group_score_categories'
    ...
    context 'when discipline given' do
      ...
      let(:group_score_category) { create(:group_score_category, group_score_type:) }

      it 'returns group_score_categories' do
        get '/api/group_score_categories', params: { discipline: 'gs' }
        expect_json_response
        expect(json_body[:group_score_categories].first).to eq(
          id: group_score_category.id,
          group_score_type: 'WKO',
    ...
    context 'when competition_id given' do
      ...
      it 'returns group_score_categories' do
        get '/api/group_score_categories', params: { competition_id: group_score_category2.competition.id }
        expect_json_response
        expect(json_body[:group_score_categories].first).to eq(
  ...
  describe 'POST create' do
    let(:r) { -> { post '/api/group_score_categories', params: } }
    let(:params) do
