...
RSpec.describe API::PeopleController, type: :controller do
  ...
  describe 'POST create' do
    it 'creates new person', login: :api do
      expect do
        post :create, params: { person: { first_name: 'Alfred', last_name: 'Meier', gender: 'male', nation_id: nation.id } }
  ...
  describe 'PUT update' do
    subject { -> { put :update, params: { id: person.id, person: { first_name: 'Vorname', last_name: 'Nachname', nation_id: nation.id } } } }
